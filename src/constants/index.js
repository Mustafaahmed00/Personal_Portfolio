...
const experiences = [
  ...
  },
  {
    ...
    points: [
      ...
      "Architected and deployed scalable financial applications on AWS using ECS and Lambda functions, implementing automated CI/CD pipelines with GitHub Actions and integrating S3 for secure file storage, reducing infrastructure costs and significantly improving application reliability.",
      "Established comprehensive testing framework using Jest and pytest, implementing automated testing pipelines that significantly enhanced code quality and reduced deployment issues effectively.",
    ],
  },
  {
